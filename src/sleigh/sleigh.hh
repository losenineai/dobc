...
class Sleigh : public SleighBase {
  LoadImageB *loader;			///< The mapped bytes in the program
...
public:
  Sleigh(LoadImageB *ld,ContextDatabase *c_db);		///< Constructor
  virtual ~Sleigh(void);				///< Destructor
  void reset(LoadImageB *ld,ContextDatabase *c_db);	///< Reset the engine for a new program
