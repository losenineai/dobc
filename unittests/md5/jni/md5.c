 ...
 */
void md5Init(MD5Context *ctx) __attribute((__annotate__(("bcf,fla,sub"))))
{
	ctx->size = (uint64_t)0;
...
void md5Update(MD5Context *ctx, uint8_t *input_buffer, size_t input_len) __attribute((__annotate__(("bcf,fla,sub"))))
{
	uint32_t input[16];
